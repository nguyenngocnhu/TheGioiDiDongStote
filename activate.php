...
<?php
	...
	if(!isset($_GET['code']) OR !isset($_GET['user'])){
		$output .= '
            ...
            <h4>You may <a href="signup.html">Signup</a> or back to <a href="index.html">Homepage</a>.</h4>
		'; 
	}
	else{
		$conn = $pdo->open();
		...
		if($row['numrows'] > 0){
			if($row['status']){
				$output .= '
		            ...
		            <h4>You may <a href="login.html">Login</a> or back to <a href="index.html">Homepage</a>.</h4>
				';
			}
			else{
				try{
